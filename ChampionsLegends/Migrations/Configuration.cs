    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ChampionsLegends.Models.AppBD>
    {
        ...
        protected override void Seed(ChampionsLegends.Models.AppBD context)
        {
            ...
            var cham = new List<Champions> {
                ...
                new Champions {ID_Champion = 3, Foto = "https://ddragon.leagueoflegends.com/cdn/8.10.1/img/champion/Orianna.png", Historia = "sadasdsa", Nome = "Orianna", Titulo = "the Lady of Clockwork", Role = "Mage", Region = "Piltolver", RelatedChampions = "Blitzcrank, Akali, Viktor", /*ListaAbilidades = new List<Abilities> {Abili[0],Abili[1],Abili[2],Abili[3],Abili[4] }*/ },
                ...
                new Champions {ID_Champion = 8, Foto = "https://ddragon.leagueoflegends.com/cdn/8.10.1/img/champion/Orianna.png", Historia = "sadasdsa", Nome = "Jarvan IV", Titulo = "the Exemplar of Demacia", Role = "Tank", Region = "Demacia", RelatedChampions = "Garen,Shyvana,Quinn", /*ListaAbilidades = new List<Abilities> {Abili[0],Abili[1],Abili[2],Abili[3],Abili[4] }*/ },
                new Champions {ID_Champion = 9, Foto = "https://ddragon.leagueoflegends.com/cdn/8.10.1/img/champion/JarvanIV.png", Historia = "sadasdsa", Nome = "Caitlyn", Titulo = "Sheriff of Piltover", Role = "Marksman", Region = "Piltolver", RelatedChampions = "Akali,Jayce,Ezreal", /*ListaAbilidades = new List<Abilities> {Abili[0],Abili[1],Abili[2],Abili[3],Abili[4] }*/ },
